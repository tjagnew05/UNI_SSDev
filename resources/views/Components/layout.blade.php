                ...
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <img class="h-8 w-8" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPsSyxJRh5JaRBDUACz0DgHpJng-pu1upnTw&s"
                                 alt="Your Company">
                        </div>
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        <div class="flex-shrink-0">
                            <img class="h-10 w-10 rounded-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPsSyxJRh5JaRBDUACz0DgHpJng-pu1upnTw&s"
                                 alt="">
                        </div>
                        <div class="ml-3">
